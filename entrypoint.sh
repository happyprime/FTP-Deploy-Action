...
lftp $FTP_METHOD://$FTP_SERVER:$FTP_PORT -u $FTP_USERNAME,$FTP_PASSWORD -e "set ftp:ssl-allow no; mirror -x node_modules/ -X vendor/ -X .git/ -X .github/ --verbose --delete --delete-excluded -R $LOCAL_DIR $REMOTE_DIR; quit"
